...
import io.misskey.mc.timeattacker.utils.Ticks
import java.io.File
...
class Config constructor(val configName: String, private val onReloaded: Consumer<Config>? = null) {
        ...
        set(value) {
            ...
            if (field) {
                object : BukkitRunnable() {
                    ...
                    runTaskTimer(TimeattackerPlugin.instance, 0L, Ticks.from(5.0).toLong())
                    autoSaveWorker = this
                }
            } else {
    ...
    companion object {
        ...
        private fun openFile(configName: String): File {
            val folder = TimeattackerPlugin.instance.dataFolder
